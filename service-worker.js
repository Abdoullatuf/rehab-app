const CACHE_NAME = 'monprog-v4-2026-04-11-2';
const HTML_FALLBACK = './index.html';
const STATIC_ASSETS = [
  './manifest.json?v=20260411-2',
  './styles/main.css?v=20260411-2',
  './styles/components.css?v=20260411-2',
  './styles/animations.css?v=20260411-2',
  './js/config/firebase-config.js?v=20260411-2',
  './js/modules/validation.js?v=20260411-2',
  './js/modules/notifications.js?v=20260411-2',
  './js/modules/storage.js?v=20260411-2',
  './js/modules/firebase.js?v=20260411-2',
  './js/modules/ui.js?v=20260411-2',
  './js/modules/seriesTracker.js?v=20260411-2',
  './js/modules/exercises.js?v=20260411-2',
  './js/services/exerciseService.js?v=20260411-2',
  './js/services/syncService.js?v=20260411-2',
  './js/seed.js?v=20260411-2',
  './js/app.js?v=20260411-2',
